...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        "flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none select-none focus:bg-accent data-[state=open]:bg-accent [&_svg]:size-4",
        inset && "pl-8",
        className,
      )}
      {...props}
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        inset && "pl-8",
        variant === "destructive" &&
          "text-destructive focus:bg-danger-muted focus:text-destructive",
        className,
      )}
      {...props}
    />
